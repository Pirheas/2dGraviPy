...
def generate_pluto_system() -> List[Body]:
    bodies = []
    bodies.append(Body('Pluto', 1.314e22, 0, 0, 0, 25.35, 'DARK_BLUE'))
    bodies[-1].radius = 7
    bodies.append(Body('Charon', 1.586e21, 17_536_000, 0, 0, -210, 'PURE_RED'))
    bodies[-1].radius = 5
...
def generate_dual_stars_system() -> List[Body]:
    bodies = []
    bodies.append(Body('Star 1', 1.5e30, 0.3 * UA, 0, 0, -15_800, 'PURE_BLUE'))
    bodies[-1].radius = 6
    bodies.append(Body('Star 2', 1.5e30, -0.3 * UA, 0, 0, 15_800, 'PURE_RED'))
    bodies[-1].radius = 6
